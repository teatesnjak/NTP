//fajl sa funkcijom za odabir 1, unos gradjana
...
void unos (gradjanin g[], int& brojacGradjana){
	...
	cout << "\tJMBG: ";
	cin >> g[brojacGradjana].jmbg; //unos jmbg-a gradjana
...
//neki su getline zbog problema koji su nam se javljali kada smo razmake ili previse karaktera unosile

	ofstream outfile("licne-informacije.txt", ios::app); //kreiranje .txt fajla

//izgled .txt fajla zvanog licne-informacije
...
brojacGradjana++; //pohranjuje nas unos gradjanina
}
